...
```{r}
print(ggplot(year_trend, aes(x = year, y = n)) +
  geom_line() +
  labs(title = "Anual number of injuries", x = "Year", y = "Number of injuries") +
  theme_minimal()
)
```
...
ggplot(gender_trend, aes(x = gender, y = n)) +
...
ggplot(comparison, aes(x = gender, y = age)) +
